<header>
    <nav class="navbar navbar-expand navbar-light navbar-top">
        <div class="container-fluid">
            ...
            <h4 class="mb-lg-0">Laboratory Information System</h4>
            ...
            <div class="collapse navbar-collapse text-end" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-lg-0">
                    <li class="nav-item dropdown me-1 hidden">
                        <a class="nav-link active  text-gray-600" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class='bx bx-envelope bi-sub fs-4'></i>
                        </a>
                        <ul class="" aria-labelledby="dropdownMenuButton">
                            {{-- <li>
                                <h6 class="">Mail</h6>
                            </li>
                            <li><a class="" href="#">No new mail</a></li> --}}
                        </ul>
                    </li>
                    <li class="nav-item dropdown me-3 hidden">
                        <a class="nav-link active  text-gray-600" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                            <i class='bx bx-bell bi-sub fs-4'></i>
                            <span class=""></span>
                        </a>
                ...
                <div class="dropdown">
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex text-end">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 mt-2 text-gray-600">{{ auth()->user()->name }}</h6>
                                {{-- <p class="mb-0 text-sm text-gray-600">{{ auth()->user()->getRoleName() }}</p> --}}
                            </div>
