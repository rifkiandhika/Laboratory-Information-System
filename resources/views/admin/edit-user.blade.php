...
<div class="content" id="scroll-content">
    <div class="container-fluid">
      ...
      <div class="d-sm-flex  mt-3">
        <h1 class="h3 mb-0 text-gray-600">Edit user</h1>
      </div>
                      ...
                      <form>
                          ...
                          <div class="row gx-3 mb-3">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input class="form-control" id="inputFirstName" type="text" placeholder="" value="John" />
                              </div>
                              <!-- Form Group (last name)-->
                              <div class="col-md-6">
                                  <label class="small mb-1" for="inputLastName">Last name</label>
                                  <input class="form-control" id="inputLastName" type="text" placeholder="Enter your last name" value="Doe" />
                              </div>
                          </div>
                          <!-- Form Group (email address)-->
                          <div class="mb-3">
                              <label class="small mb-1" for="inputEmailAddress">Email address</label>
                              <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" value="johndoe@example.com" />
                          </div>
                          <div class="mb-3">
                              <label class="small mb-1" for="username">Username</label>
                              <input class="form-control" id="username" type="email" placeholder="Username" value="johndoe" />
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                              ...
                              <div class="form-check">
                                  <input class="form-check-input" id="admin" type="checkbox" value="" checked/>
                                  <label class="form-check-label" for="admin">Admin</label>
                              </div>
                              <div class="form-check">
                                  <input class="form-check-input" id="loket" type="checkbox" value="" checked/>
                                  <label class="form-check-label" for="loket">Loket</label>
                              </div>
                              <div class="form-check">
                                  <input class="form-check-input" id="dokter" type="checkbox" value="" checked/>
                                  <label class="form-check-label" for="dokter">Dokter</label>
                              </div>
                              <div class="form-check">
                                  <input class="form-check-input" id="lab" type="checkbox" value="" checked/>
