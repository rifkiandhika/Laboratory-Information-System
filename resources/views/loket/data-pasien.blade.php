        ...
        <div class="col-xl-7 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-sm btn-outline-teal my-2 my-sm-0" type="submit">Search</button>
                    </form>
                </div>
                            ...
                            <tr class="mt-2">
                                ...
                                <td>
                                    @if ($dp->status == "Belum Dilayani")
                                        <span class="badge bg-danger text-white">{{ $dp->status }}</span>
                                    @elseif($dp->status == "Telah Dikirim ke Lab")
                                        <span class="badge bg-success text-white">{{ $dp->status }}</span>
                                    @elseif($dp->status == "Diproses")
                                        <span class="badge bg-warning text-white">{{ $dp->status }}</span>
                                    @endif
                                </td>
                                <td>
                                    {{-- {!! DNS1D::getBarcodeSVG( $dp->no_lab.'\tMuhsin' , 'C128B', 0.9,40, 'black', false) !!} --}}

                                    {{-- <img style="width: 4cm" alt='Barcode Generator TEC-IT' src='https://barcode.tec-it.com/barcode.ashx?data={{ $dp->no_lab }}%5CtMuhsin&code=Code128&translate-esc=on&unit=Fit&imagetype=Png&showhrt=no&eclevel=L&dmsize=Default&modulewidth=400'/> --}}
                                    <a href="{{ route('print.barcode', $dp->no_lab) }}" class="btn btn-sm btn-outline-warning" style="font-size: 15px">Barcode</a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-sm btn-outline-teal" style="font-size: 15px" id="open-pasien" data-lab="{{ $dp->no_lab }}" onclick="previewPasien('{{ $dp->no_lab }}')">Preview</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <form action="#" method="post">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="row" style="margin-top: -5px;">
                        ...
                        <div class="col-lg">
                            <input type="text" readonly class="form-control-plaintext font-weight-bold" id="staticEmail" value=": LAB623452">
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="pasien col-xl-6 mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": 012345">
                    </div>
                    </div>
                    <div class="row">
                    <label for="staticEmail" class="col-sm-5 col-form-label">NIK</label>
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": 312423424">
                    </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": Tidak Disebutkan">
                    </div>
                    </div>
                    <div class="row">
                    <label for="staticEmail" class="col-sm-5 col-form-label">Umur</label>
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": 20 tahun">
                    </div>
                    </div>
                    <div class="row">
                    <label for="staticEmail" class="col-sm-5 col-form-label">Alamat</label>
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": Porong">
                    </div>
                    </div>
                    <div class="row">
                    <label for="staticEmail" class="col-sm-5 col-form-label">Telp</label>
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": 08123532123">
                    </div>
                    </div>
                    <div class="row">
                    <label for="staticEmail" class="col-sm-5 col-form-label">Jenis Pasien</label>
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": BPJS">
                    </div>
                    </div>
                    <div class="row">
                ...
                <div class="dokter col-xl-6 mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value=": mati suri">
                    </div>
                    </div>
                </div>
                </div>
            ...
            .then(data => {
                ...
                var html = `<div class="container-preview">
                                ...
                                <div class="mt-4 text-right small">
                                    ...
                                    <button class="btn btn-sm btn-outline-teal font-weight-normal mx-2" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable" onclick="barcode('`+ data.data_pasien.no_lab +`')">Cetak Barcode</button>
