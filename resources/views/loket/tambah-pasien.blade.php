                        ...
                        <form action="{{ route('pasien.store') }}" method="post" >
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="row" style="margin-top: -5px;">
                                    ...
                                    <div class="col-lg">
                                        <input type="text" readonly class="form-control-plaintext font-weight-bold" id="no-lab" name="nolab" value="{{ $no_lab }}">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input class="form-check-input child-pemeriksaan-hematologi" type="checkbox" name="cito" value="1" id="cito">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-6">
                                        <input type="text" class="form-control" name="norm" aria-label="" placeholder="Masukan No RM">
                                    </div>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="basic-url">Nomor Induk Kewarganegaraan</label>
                                    <div class="input-group mb-6">
                                        <input type="text" class="form-control" name="nik" aria-label="" placeholder="Masukan NIK">
                                    </div>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="basic-url">Nama Lengkap</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="nama" aria-label="" placeholder="Masukkan Nama Lengkap">
                                    </div>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="" id="" name="notelepon"
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="dokter">
                                        ...
                                        <option value="2">dr. Poli Umum</option>
                                        <option value="3">dr. Poli KIA</option>
                                    </select>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="name">Diagnosa</label>
                                    <select name="diagnosa" id="diagnosa" class="form-control diagnosa"></select>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="basic-url">Jenis Pelayanan</label>
                                    <div class="row">
                                        <div class="form-check ml-3">
                                            <input class="form-check-input child-pemeriksaan-hematologi" type="radio" name="jenispelayanan" value="umum" id="umum" checked>
                                            <label class="form-check-label" for="umum">
                                                Umum
                                            </label>
                                        </div>
                                        <div class="form-check ml-3">
                                            <input class="form-check-input child-pemeriksaan-hematologi" type="radio" name="jenispelayanan" value="bpjs" id="bpjs">
                                            <label class="form-check-label" for="bpjs">
                                                BPJS
                                            </label>
                                        </div>
                                        <div class="form-check ml-3">
                                            <input class="form-check-input child-pemeriksaan-hematologi" type="radio" name="jenispelayanan" value="asuransi" id="asuransi">
                            ...
                            <div class="row">
                                <div class="col-8 d-flex">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control-plaintext font-weight-bold" name="hargapemeriksaan" id="harga-pemeriksaan" value="0" readonly>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="row">
                                            <input class="form-control mr-sm-2 mb-2" type="search" placeholder="Search" aria-label="Search" name="search">
                            ...
                            <div class="row pemeriksaan">
                                @foreach ($data_departement as $d_depart)
                                    <div class="col-xl-3">
                                        <!-- Parent Pemeriksaan -->
                                        <div class="parent-pemeriksaan" id="parent-pemeriksaan">
                                            <div class="heading heading-color btn-block  mb-3">{{ $d_depart->nama_departement }}</div>
                                            <!-- Child pemeriksaan -->
                                            <div class="child-pemeriksaan" id="child-pemeriksaan-hematologi">
                                                @foreach ($data_pemeriksaan as $d_pemeriksaan)
                                                    @if ($d_pemeriksaan->id_departement == $d_depart->id_departement)
                                                        <div class="form-check">
                                                        <input class="form-check-input child-pemeriksaan" type="checkbox" name="pemeriksaan[]" value="{{ $d_pemeriksaan->id_departement }},{{ $d_pemeriksaan->nama_parameter }}" id="{{ $d_pemeriksaan->nama_parameter }}" onclick="checkpemeriksaan({{ $d_pemeriksaan->harga }})" data-harga="{{ $d_pemeriksaan->harga }}">
                                                        <label class="form-check-label" for="{{ $d_pemeriksaan->nama_parameter }}">
                                                            {{ $d_pemeriksaan->nama_pemeriksaan }} {{ $d_pemeriksaan->harga }}
                                                        </label>
                                                        </div>
                                                    @endif
                                                @endforeach
